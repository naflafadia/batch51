...
app.post('/add-project', checkAuth, addProject)
...
async function updateProject(req, res) {
    ...
    const checkboxes = ['nodeJs', 'nextJs', 'reactJs', 'typeScript'].filter(checkbox => req.body[checkbox])
        ...
        const query = `UPDATE projects SET name='${name}', start_date='${start}', end_date='${end}', description='${description}', technologies=ARRAY['${checkboxes.join("','")}'] WHERE id=${id}`
